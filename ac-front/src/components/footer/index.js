    ...
    <Styled.Footer id="footer">
      <Styled.ContentFooter>
        ...
        <Styled.Left>
          ...
          <br/>
          <Styled.Link onClick={openMaps}>R. Funchal, 538, 2º A - Itaim Bibi, São Paulo - SP, 04551-060</Styled.Link>
          <div>
            <Styled.Flex>
              <Styled.Link onClick={() => openWhatsapp(1)}>(11) 9 1399-1412</Styled.Link>
              <Styled.WhatsappNumberIcon onClick={() => openWhatsapp(1)}/>
            </Styled.Flex>
            <Styled.Flex>
            <Styled.Link onClick={() => openWhatsapp(2)}>(11) 9 1272-1893</Styled.Link>
